 ...
 * Ethical AI Analysis Framework currently requires exactly 1 ethical-expert.
 * 
...
module.exports = {
    ETHICAL_EXPERT_CARDINALITY: {
        min: 1,
        max: 1,
        description: 'Ethical AI Analysis requires exactly ONE ethical-expert per project for ethical plurality validation'
    },
