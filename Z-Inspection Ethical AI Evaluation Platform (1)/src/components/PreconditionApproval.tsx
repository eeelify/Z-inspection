...
const roleContent = {
  'ethical-expert': {
    ...
    disclaimer: 'As an ethical expert on the Z-Inspection platform, you will be evaluating AI systems from an ethical, legal, and societal perspective.',
    responsibilities: [
  ...
  'medical-expert': {
    ...
    disclaimer: 'As a medical expert on the Z-Inspection platform, you will be evaluating AI systems from a healthcare and medical ethics perspective.',
    responsibilities: [
  ...
  'use-case-owner': {
    ...
    disclaimer: 'As a use case owner on the Z-Inspection platform, you will be providing domain expertise and stakeholder perspective for your assigned use cases.',
    responsibilities: [
...
export function PreconditionApproval({ userRole, onApproval, onBack }: PreconditionApprovalProps) {
  const content = roleContent[userRole as keyof typeof roleContent];
  const roleColor = roleColors[userRole as keyof typeof roleColors];
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="px-8 py-8">
            <div className="mb-6">
              <h3 className="text-lg mb-3 text-gray-900">Platform Disclaimer</h3>
            ...
            <div className="mb-8">
              <h3 className="text-lg mb-4 text-gray-900">Your Responsibilities</h3>
              <ul className="space-y-3">
                {content.responsibilities.map((responsibility, index) => (
                  <li key={index} className="flex items-start">
                    <CheckCircle className="h-5 w-5 mr-3 mt-0.5" style={{ color: roleColor }} />
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-yellow-700 text-sm">
                    This platform is designed for ethical evaluation and research purposes. 
                    All evaluations should be conducted with professional integrity and objectivity. 
                    Your assessments will contribute to the responsible development of AI systems.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-600">
                By continuing, you agree to follow the Z-Inspection methodology guidelines.
              </div>
              <button
                onClick={onApproval}
