...
const legalExpertQuestions = [
  ...
  {
    code: 'L1',
    principle: 'LAWFULNESS & COMPLIANCE',
    ...
    options: [
      { key: 'fully_compliant', label: { en: 'Fully compliant / Tam uyumlu', tr: 'Tam uyumlu' }, score: 4 },
      { key: 'partially_compliant', label: { en: 'Partially compliant / Kısmen uyumlu', tr: 'Kısmen uyumlu' }, score: 2 },
      { key: 'non_compliant', label: { en: 'Non-compliant / Uyumlu değil', tr: 'Uyumlu değil' }, score: 1 },
      { key: 'not_enough_info', label: { en: 'Not enough information / Yeterli bilgi yok', tr: 'Yeterli bilgi yok' }, score: 2 }
    ],
    required: true,
    order: 50
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'yes_explicit_consent', label: { en: 'Yes, explicit consent obtained / Evet, açık rıza alınıyor', tr: 'Evet, açık rıza alınıyor' }, score: 4 },
      { key: 'yes_legal_basis', label: { en: 'Yes, another legal basis applies / Evet, başka bir hukuki dayanak var', tr: 'Evet, başka bir hukuki dayanak var' }, score: 4 },
      { key: 'partially', label: { en: 'Partially / Kısmen', tr: 'Kısmen' }, score: 2 },
      { key: 'no', label: { en: 'No / Hayır', tr: 'Hayır' }, score: 1 },
      { key: 'unknown', label: { en: 'Unknown / Bilinmiyor', tr: 'Bilinmiyor' }, score: 2 }
    ],
    required: true,
    order: 51
  },
  ...
  {
    code: 'L4',
    principle: 'RISK MANAGEMENT & HARM PREVENTION',
    appliesToRoles: ['legal-expert'],
    text: { 
  ...
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'yes_clearly_defined', label: { en: 'Yes, purposes are clearly defined / Evet, amaçlar net', tr: 'Evet, amaçlar net' }, score: 4 },
      { key: 'mostly_yes', label: { en: 'Mostly yes / Büyük ölçüde evet', tr: 'Büyük ölçüde evet' }, score: 3 },
      { key: 'partially', label: { en: 'Partially / Kısmen', tr: 'Kısmen' }, score: 2 },
      { key: 'no_unclear', label: { en: 'No, purposes are unclear / Hayır, amaçlar belirsiz', tr: 'Hayır, amaçlar belirsiz' }, score: 1 }
    ],
    required: true,
    order: 54
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'fully_respected', label: { en: 'Fully respected / Tamamen uyuluyor', tr: 'Tamamen uyuluyor' }, score: 4 },
      { key: 'mostly_respected', label: { en: 'Mostly respected / Büyük ölçüde uyuluyor', tr: 'Büyük ölçüde uyuluyor' }, score: 3 },
      { key: 'partially_respected', label: { en: 'Partially respected / Kısmen uyuluyor', tr: 'Kısmen uyuluyor' }, score: 2 },
      { key: 'not_respected', label: { en: 'Not respected / Uyulmuyor', tr: 'Uyulmuyor' }, score: 1 }
    ],
    required: true,
    order: 55
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'clearly_defined_compliant', label: { en: 'Clearly defined and compliant / Net ve hukuka uygun', tr: 'Net ve hukuka uygun' }, score: 4 },
      { key: 'defined_needs_clarification', label: { en: 'Defined but needs clarification / Tanımlı ancak net değil', tr: 'Tanımlı ancak net değil' }, score: 2 },
      { key: 'partially_defined', label: { en: 'Partially defined / Kısmen tanımlı', tr: 'Kısmen tanımlı' }, score: 2 },
      { key: 'not_defined', label: { en: 'Not defined / Tanımlı değil', tr: 'Tanımlı değil' }, score: 1 }
    ],
    required: true,
    order: 56
  },
  {
    ...
    options: [
      { key: 'fully_compliant', label: { en: 'Fully compliant / Tam uyumlu', tr: 'Tam uyumlu' }, score: 4 },
      { key: 'compliant_safeguards', label: { en: 'Compliant with safeguards / Güvencelerle uyumlu', tr: 'Güvencelerle uyumlu' }, score: 3 },
      { key: 'potential_risks', label: { en: 'Potential legal risks identified / Hukuki riskler mevcut', tr: 'Hukuki riskler mevcut' }, score: 2 },
      { key: 'not_compliant', label: { en: 'Not compliant / Uyumlu değil', tr: 'Uyumlu değil' }, score: 1 },
      { key: 'not_applicable', label: { en: 'Not applicable / Uygulanamaz', tr: 'Uygulanamaz' }, score: 3 }
    ],
    required: true,
    order: 57
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'strong_measures', label: { en: 'Strong measures in place / Güçlü önlemler mevcut', tr: 'Güçlü önlemler mevcut' }, score: 4 },
      { key: 'adequate_improvable', label: { en: 'Adequate but improvable / Yeterli ancak geliştirilebilir', tr: 'Yeterli ancak geliştirilebilir' }, score: 3 },
      { key: 'weak_measures', label: { en: 'Weak measures / Zayıf önlemler', tr: 'Zayıf önlemler' }, score: 2 },
      { key: 'no_clear_measures', label: { en: 'No clear measures / Net önlem yok', tr: 'Net önlem yok' }, score: 1 }
    ],
    required: true,
    order: 58
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'strictly_restricted', label: { en: 'Strictly restricted / Sıkı şekilde sınırlı', tr: 'Sıkı şekilde sınırlı' }, score: 4 },
      { key: 'mostly_restricted', label: { en: 'Mostly restricted / Büyük ölçüde sınırlı', tr: 'Büyük ölçüde sınırlı' }, score: 3 },
      { key: 'partially_restricted', label: { en: 'Partially restricted / Kısmen sınırlı', tr: 'Kısmen sınırlı' }, score: 2 },
      { key: 'not_restricted', label: { en: 'Not restricted / Sınırlı değil', tr: 'Sınırlı değil' }, score: 1 }
    ],
    required: true,
    order: 59
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'yes_clearly_defined_tested', label: { en: 'Yes, clearly defined and tested / Net ve test edilmiş', tr: 'Net ve test edilmiş' }, score: 4 },
      { key: 'defined_not_tested', label: { en: 'Defined but not tested / Tanımlı ancak test edilmemiş', tr: 'Tanımlı ancak test edilmemiş' }, score: 2 },
      { key: 'informal_unclear', label: { en: 'Informal or unclear / Gayri resmi veya belirsiz', tr: 'Gayri resmi veya belirsiz' }, score: 2 },
      { key: 'no_procedure', label: { en: 'No procedure / Prosedür yok', tr: 'Prosedür yok' }, score: 1 }
    ],
    required: true,
    order: 60
  },
  {
    code: 'L12',
    principle: 'USER RIGHTS & AUTONOMY',
    appliesToRoles: ['legal-expert'],
    text: { 
    ...
    answerType: 'single_choice',
    options: [
      { key: 'fully_supported', label: { en: 'Fully supported / Tam destekleniyor', tr: 'Tam destekleniyor' }, score: 4 },
      { key: 'partially_supported', label: { en: 'Partially supported / Kısmen destekleniyor', tr: 'Kısmen destekleniyor' }, score: 2 },
      { key: 'difficult_practice', label: { en: 'Difficult in practice / Pratikte zor', tr: 'Pratikte zor' }, score: 2 },
      { key: 'not_supported', label: { en: 'Not supported / Desteklenmiyor', tr: 'Desteklenmiyor' }, score: 1 }
    ],
    required: true,
    order: 61
  },
  ...
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'defined_binding', label: { en: 'Defined and binding', tr: 'Tanımlı ve bağlayıcı' }, score: 4 },
      { key: 'defined_weak_binding', label: { en: 'Defined but weak binding', tr: 'Tanımlı ancak zayıf bağlayıcılık' }, score: 2 },
      { key: 'informal_insufficient', label: { en: 'Informal or insufficient', tr: 'Gayri resmi veya yetersiz' }, score: 2 },
      { key: 'not_defined', label: { en: 'Not defined', tr: 'Tanımlı değil' }, score: 1 }
    ],
    required: true,
    order: 63
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'correctly_classified', label: { en: 'Correctly classified / Doğru sınıflandırılmış', tr: 'Doğru sınıflandırılmış' }, score: 4 },
      { key: 'mostly_correct', label: { en: 'Mostly correct, minor issues / Büyük ölçüde doğru', tr: 'Büyük ölçüde doğru' }, score: 3 },
      { key: 'partially_correct', label: { en: 'Partially correct / Kısmen doğru', tr: 'Kısmen doğru' }, score: 2 },
      { key: 'incorrectly_classified', label: { en: 'Incorrectly classified / Yanlış sınıflandırılmış', tr: 'Yanlış sınıflandırılmış' }, score: 1 },
      { key: 'not_enough_info', label: { en: 'Not enough information / Yeterli bilgi yok', tr: 'Yeterli bilgi yok' }, score: 2 }
    ],
    required: true,
    order: 64
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'no_prohibited', label: { en: 'No prohibited practices identified / Yasaklı uygulama yok', tr: 'Yasaklı uygulama yok' }, score: 4 },
      { key: 'potential_risk', label: { en: 'Potential risk identified / Olası risk mevcut', tr: 'Olası risk mevcut' }, score: 2 },
      { key: 'partially_overlaps', label: { en: 'Partially overlaps with prohibited practices / Kısmen örtüşüyor', tr: 'Kısmen örtüşüyor' }, score: 2 },
      { key: 'clearly_violates', label: { en: 'Clearly violates prohibited practices / Açıkça yasaklı uygulama içeriyor', tr: 'Açıkça yasaklı uygulama içeriyor' }, score: 1 },
  ...
  },
  {
    ...
    options: [
      { key: 'fully_compliant', label: { en: 'Fully compliant / Tam uyumlu', tr: 'Tam uyumlu' }, score: 4 },
      { key: 'mostly_compliant', label: { en: 'Mostly compliant / Büyük ölçüde uyumlu', tr: 'Büyük ölçüde uyumlu' }, score: 3 },
      { key: 'partially_compliant', label: { en: 'Partially compliant / Kısmen uyumlu', tr: 'Kısmen uyumlu' }, score: 2 },
      { key: 'non_compliant', label: { en: 'Non-compliant / Uyumlu değil', tr: 'Uyumlu değil' }, score: 1 },
      { key: 'not_applicable', label: { en: 'Not applicable / Uygulanamaz', tr: 'Uygulanamaz' }, score: 3 }
    ],
  ...
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'clearly_defined_enforceable', label: { en: 'Clearly defined and enforceable / Net ve bağlayıcı', tr: 'Net ve bağlayıcı' }, score: 4 },
      { key: 'defined_weak_enforcement', label: { en: 'Defined but weak enforcement / Tanımlı ancak bağlayıcılığı zayıf', tr: 'Tanımlı ancak bağlayıcılığı zayıf' }, score: 2 },
      { key: 'partially_defined', label: { en: 'Partially defined / Kısmen tanımlı', tr: 'Kısmen tanımlı' }, score: 2 },
      { key: 'not_defined', label: { en: 'Not defined / Tanımlı değil', tr: 'Tanımlı değil' }, score: 1 },
      { key: 'not_sure', label: { en: 'Not sure / Emin değilim', tr: 'Emin değilim' }, score: 2 }
    ],
  ...
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'fully_prepared', label: { en: 'Fully prepared / Tamamen hazırlanmış', tr: 'Tamamen hazırlanmış' }, score: 4 },
      { key: 'mostly_prepared', label: { en: 'Mostly prepared / Büyük ölçüde hazırlanmış', tr: 'Büyük ölçüde hazırlanmış' }, score: 3 },
      { key: 'partially_prepared', label: { en: 'Partially prepared / Kısmen hazırlanmış', tr: 'Kısmen hazırlanmış' }, score: 2 },
      { key: 'not_prepared', label: { en: 'Not prepared / Hazırlanmamış', tr: 'Hazırlanmamış' }, score: 1 },
      { key: 'not_sure', label: { en: 'Not sure / Emin değilim', tr: 'Emin değilim' }, score: 2 }
    ],
    required: true,
    order: 68
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'clearly_defined_operational', label: { en: 'Clearly defined and operational / Net ve aktif', tr: 'Net ve aktif' }, score: 4 },
      { key: 'defined_limited', label: { en: 'Defined but limited / Tanımlı ancak sınırlı', tr: 'Tanımlı ancak sınırlı' }, score: 2 },
      { key: 'informal_unclear', label: { en: 'Informal or unclear / Gayri resmi veya belirsiz', tr: 'Gayri resmi veya belirsiz' }, score: 2 },
      { key: 'not_defined', label: { en: 'Not defined / Tanımlı değil', tr: 'Tanımlı değil' }, score: 1 }
    ],
    required: true,
  ...
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'fully_present_compliant', label: { en: 'Fully Present and Compliant / Tamamen mevcut ve uyumlu', tr: 'Tamamen mevcut ve uyumlu' }, score: 4 },
      { key: 'present_weak_legal', label: { en: 'Present but Weak Legal / Mevcut ancak hukuki dayanağı zayıf', tr: 'Mevcut ancak hukuki dayanağı zayıf' }, score: 2 },
      { key: 'not_defined', label: { en: 'Not Defined / Tanımlı değil', tr: 'Tanımlı değil' }, score: 1 },
      { key: 'not_applicable', label: { en: 'Not Applicable / Uygulanamaz', tr: 'Uygulanamaz' }, score: 3 }
    ],
    required: true,
