...
const technicalExpertQuestions = [
  // 1️⃣ TECHNICAL ROBUSTNESS & SAFETY
  {
    ...
    options: [
      { key: 'yes_fully_sufficient', label: { en: 'Yes, fully sufficient / Evet, tamamen yeterli', tr: 'Evet, tamamen yeterli' }, score: 4 },
      { key: 'partially_sufficient', label: { en: 'Partially sufficient / Kısmen yeterli', tr: 'Kısmen yeterli' }, score: 2 },
      { key: 'insufficient', label: { en: 'Insufficient / Yetersiz', tr: 'Yetersiz' }, score: 1 }
    ],
    required: true,
    order: 71
  },
  ...
  // 2️⃣ TECHNICAL ROBUSTNESS & SAFETY – SECURITY & RESILIENCE
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'strong_resilience', label: { en: 'Strong resilience / Güçlü dayanıklılık', tr: 'Güçlü dayanıklılık' }, score: 4 },
      { key: 'moderate_resilience', label: { en: 'Moderate resilience / Orta düzey dayanıklılık', tr: 'Orta düzey dayanıklılık' }, score: 3 },
      { key: 'weak_resilience', label: { en: 'Weak resilience / Zayıf dayanıklılık', tr: 'Zayıf dayanıklılık' }, score: 2 },
      { key: 'no_resilience', label: { en: 'No resilience / Dayanıklılık yok', tr: 'Dayanıklılık yok' }, score: 1 },
  ...
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'highly_exposed', label: { en: 'Highly exposed / Yüksek derecede maruz', tr: 'Yüksek derecede maruz' }, score: 1 },
      { key: 'moderately_exposed', label: { en: 'Moderately exposed / Orta derecede maruz', tr: 'Orta derecede maruz' }, score: 2 },
      { key: 'slightly_exposed', label: { en: 'Slightly exposed / Düşük derecede maruz', tr: 'Düşük derecede maruz' }, score: 3 },
      { key: 'not_exposed', label: { en: 'Not exposed / Maruz değil', tr: 'Maruz değil' }, score: 4 },
  ...
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'strong_security', label: { en: 'Strong security / Güçlü güvenlik', tr: 'Güçlü güvenlik' }, score: 4 },
      { key: 'moderate_security', label: { en: 'Moderate security / Orta düzey güvenlik', tr: 'Orta düzey güvenlik' }, score: 3 },
      { key: 'weak_security', label: { en: 'Weak security / Zayıf güvenlik', tr: 'Zayıf güvenlik' }, score: 2 },
      { key: 'no_security', label: { en: 'No security / Güvenlik yok', tr: 'Güvenlik yok' }, score: 1 },
      { key: 'unknown', label: { en: 'Unknown / Bilinmiyor', tr: 'Bilinmiyor' }, score: 2 }
    ],
    required: true,
    order: 79
