...
const medicalExpertQuestions = [
  // 1️⃣ TECHNICAL ROBUSTNESS & SAFETY
  {
    ...
    options: [
      { key: 'yes_fully_reliable', label: { en: 'Yes, fully reliable', tr: 'Evet, tamamen güvenilir' }, score: 4 },
      { key: 'partially_reliable', label: { en: 'Partially reliable', tr: 'Kısmen güvenilir' }, score: 2 },
      { key: 'unreliable', label: { en: 'Unreliable', tr: 'Güvenilir değil' }, score: 1 },
      { key: 'not_enough_info', label: { en: 'Not enough information', tr: 'Yeterli bilgi yok' }, score: 2 }
    ],
    required: true,
    order: 25
  },
  ...
  },
  {
    ...
    options: [
      ...
      { key: 'unknown', label: { en: 'Unknown', tr: 'Bilinmiyor' }, score: 2 }
    ],
    required: true,
    order: 31
  },
  ...
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'very_clearly', label: { en: 'Very clearly defined', tr: 'Çok açık tanımlanmış' }, score: 4 },
      { key: 'partially_defined', label: { en: 'Partially Defined', tr: 'Kısmen tanımlanmış' }, score: 2 },
      { key: 'poorly_defined', label: { en: 'Poorly defined', tr: 'Zayıf tanımlanmış' }, score: 1 },
      { key: 'not_defined', label: { en: 'Not defined', tr: 'Tanımlanmamış' }, score: 0 }
    ],
    required: true,
    order: 34
  },
  {
    ...
    answerType: 'single_choice',
    options: [
      { key: 'always', label: { en: 'Always', tr: 'Her zaman' }, score: 4 },
      { key: 'in_most_cases', label: { en: 'In most cases', tr: 'Çoğu durumda' }, score: 3 },
      { key: 'rarely', label: { en: 'Rarely', tr: 'Nadiren' }, score: 1 },
      { key: 'never', label: { en: 'Never', tr: 'Hiçbir zaman' }, score: 0 }
    ],
    required: true,
    order: 35
  },
