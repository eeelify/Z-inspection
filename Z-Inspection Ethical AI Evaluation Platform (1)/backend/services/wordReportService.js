...
async function generateWordFromData(analysisData, outputPath) {
  try {
    console.log('📝 Generating Word document from data (fallback mode)...');
    ...
    console.log(`✅ Word document generated successfully (fallback): ${outputPath} (${(fileSize / 1024).toFixed(2)} KB)`);
